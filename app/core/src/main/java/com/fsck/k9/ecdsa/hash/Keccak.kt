...
object Keccak {
    ...
    fun digest(value: ByteArray): ByteArray {
        ...
        if (d and 0x80 != 0 && blockSize == rateInBytes - 1) {
            doF(uState)
        }
        ...
        var tOutputLen = outputLengthInBytes
        while (tOutputLen > 0) {
    ...
    fun IntArray.fillWith(value: Int, fromIndex: Int = 0, toIndex: Int = this.size) {
